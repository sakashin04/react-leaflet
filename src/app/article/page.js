        ...
        <main className={styles.articleMain}>
          <article className={styles.article}>
            ...
            <div className={styles.content}>
              ...
              <p>
              nextjsはreactのフレームワークです。Reactは、WebサイトやWebアプリのUI（ユーザーインターフェース）を構築するために使用されるJavaScriptライブラリです。コンポーネントベースのアーキテクチャを採用しており、小さな部品（コンポーネント）を組み合わせて複雑なUIを構築できるため、高い再利用性と保守性を誇ります。﻿
              </p>
              <h2 id="1">前提知識</h2>
              <p>メリットは以下の通りです。</p>
              <ul>
