        ...
        <main className={styles.articleMain}>
          <article className={styles.article}>
            ...
            <div className={styles.content}>
              ...
              <h3>Node.jsとは</h3>
              <p>Node.jsは、ChromeのV8 JavaScriptエンジンを基盤としたサーバーサイドJavaScript実行環境です。従来ブラウザでしか動作しなかったJavaScriptをサーバーサイドでも実行可能にし、Webアプリケーション開発の可能性を大きく広げました。特徴的な非同期I/O処理により、高いスケーラビリティを実現し、リアルタイムアプリケーションの開発に適しています。また、npmという世界最大のパッケージエコシステムを持ち、豊富なライブラリやツールを利用できます。シングルスレッドでイベント駆動型のアーキテクチャを採用しており、効率的なリソース利用が可能です。WebサーバーからAPI、CLIツールまで、様々な用途で活用されています。</p>
              ...
              <h3>Next.jsとは</h3>
              <p>Next.jsは、Reactベースのフルスタックフレームワークです。Vercelが開発を主導しており、モダンなWebアプリケーション開発に必要な機能を包括的に提供します。サーバーサイドレンダリング（SSR）と静的サイト生成（SSG）の両方をサポートし、SEOとパフォーマンスの最適化を実現します。ファイルシステムベースのルーティング、自動的なコード分割、画像最適化などの機能が組み込まれており、開発効率を大きく向上させます。また、APIルートを通じてサーバーサイド機能も実装可能で、フロントエンドとバックエンドを統合的に開発できます。Vercelへの簡単なデプロイメントや、豊富な開発者ツールも特徴です。</p>
              <h2 id="2">開発環境の構築</h2>
...
cd my-app`}</CodeBlock>
              ...
              <p>コードを変更します。</p>
              <h3>4. コードのコミット</h3>
              <img src="/1-1.png" alt="コードのコミット" width="80%" style={{display: 'block', margin: '0 auto'}} />
              <h2 id="6">vercelでデプロイ</h2>
              <p>Vercelを使用したデプロイ手順：</p>
              <p>pushした時点でvercelにも反映されるのでこのままステージングすれば。</p>
              <GlassPanel>
                <ol>
                  <li>Vercel (https://vercel.com) にアクセス</li>
                  <li>GitHubアカウントでログイン</li>
                  <li>"New Project"をクリック</li>
                  <li>デプロイするリポジトリを選択</li>
                  <li>"Deploy"をクリック</li>
                </ol>
              </GlassPanel>
              <h3>参考</h3>
